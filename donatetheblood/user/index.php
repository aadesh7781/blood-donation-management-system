					...
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<div class="heading text-center">
								<h1>Welcome</h1> <h1><?php if(isset($_SESSION['name'])) echo $_SESSION['name']; ?></h1>
							</div>
							...
							$save_date = $_SESSION['save_life_date'];
							...
							<span class="name"><h1>Congratulations!!</h1></span>
							<span><h1>You saved a life, You will have to wait 6 months to donate blood again, Thank you!!</h1></span>';
								}
